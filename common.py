...
def get_configs(entry_name: str,
    ...
    # Always prefer default.config if config.json not found
    if not os.path.exists(config_path):
        logger.info(f"Using default configuration file: {config_default_file_name}")
